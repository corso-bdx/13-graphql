...
namespace TestGQL.Types {
    public class LibroObjectType : ObjectType<Libro> {
        ...
        private class Resolver {
            public Autore? GetAutore([Parent] Libro libro, [ScopedService] TestGQLDBContext context) {
                return context.Autori.Where(x => x.AutoreID == libro.AutoreID).FirstOrDefault();
            }

            public CasaEditrice? GetCasaEditrice([Parent] Libro libro, [ScopedService] TestGQLDBContext context) {
